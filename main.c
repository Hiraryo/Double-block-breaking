...
int main(){
    ...
    soundID_1 = HgSoundLoad("9254.mp3");//ステージBGM
    soundID_2 = HgSoundLoad("Clear1.mp3");//クリア音
    soundID_3 = HgSoundLoad("GAMEOVER.mp3");//ゲームオーバーBGM
    SE_1 = HgSoundLoad("bound.mp3");
    SE_2 = HgSoundLoad("bound2.mp3");
    ...
    switch (stage_no){
        case 1:
        fp=fopen("stage1.dat","r");
        break;

        case 2:
        fp=fopen("stage2.dat","r");
        break;

        case 3:
        fp=fopen("stage3.dat","r");
        break;

        case 4:
        fp=fopen("stage4.dat","r");
        break;

        case 5:
        fp=fopen("stage5.dat","r");
        break;
    }
    if(fp==NULL){
        printf("ファイルがありません\n");
...
int bar_ball_move(){
    int image_1 = HgImageLoad("main1.png");
    for (;;){
        //ブロック表示
